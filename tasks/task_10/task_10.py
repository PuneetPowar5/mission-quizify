    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                questions = slider_val = st.slider("Number of Questions", min_value=1, max_value=10, value=1)
                ...
                if submitted:
                    ...
                    ##### YOUR CODE HERE #####
                    generator = QuizGenerator(topic=topic_input, num_questions=questions, vectorstore=chroma_creator)# Step 3: Initialize a QuizGenerator class using the topic, number of questions, and the chroma collection
