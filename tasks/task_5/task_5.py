...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        # Extract string contents from the Document objects
        document_texts = [doc.page_content for doc in self.processor.pages]

        # Splitting the pages into chunks of data for easier processing
        texts = spliter.create_documents(document_texts)
